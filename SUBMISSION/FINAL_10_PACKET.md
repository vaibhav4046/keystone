...
3. Deterministic, no-LLM verdict; a full passing test suite; one-command reproducible.
...
Tests: the full suite passes (2 skipped). CLI: demo / shadow-merge / shadow-merge --safe /
...
- Tests now the full suite passes (2 skipped); test-count copy made drift-proof (non-numeric).
